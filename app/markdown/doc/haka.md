...
Our [functional Javascript HTML and DOM manipulation toolkit.](https://github.com/eldoy/haka) The whole library is only 2K minified and is very light weight and fast. Works in all browsers, including IE.

Once included, the script loads several functions into the window object to make them available everywhere.

### Install

Add [this file](https://raw.githubusercontent.com/eldoy/haka/master/dist/haka-min.js) to your `app/assets/js` folder and include with:
```html
<script src="/js/haka-min.js"></script>
```
[Add it to your bundle instead](/doc/assets.html#bundling-and-packing) if you're using that.
